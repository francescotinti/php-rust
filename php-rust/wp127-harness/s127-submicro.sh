#!/bin/bash
# s127-submicro.sh — residuo 427 ns: sei categorie same-run (az. rev. S-126 #2)
# (criterio s127-criterio-submicro.md, committato PRIMA del run). Metodo run-micro.sh:
...
VERD="$H/s127-submicro-verdetto.out"
...
{
echo "== s127 sub-micro residuo 427 ns (criterio s127-criterio-submicro.md) =="
