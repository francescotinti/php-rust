...
ORM 6,972–7,053 PRIMA VOLTA SOTTO 7× (Δ +0,72→ rif s153: +0,41/+0,50 giù
fuori rumore, OLTRE-attesa CE1 istruita: funnel resolve_class_autoload 11
siti, magnitudine non ripartita) · dbal 7,385–7,422 · sonda ce-count k=1
SPIEGATO (args-Vec pop_keys attribuito al nome; hit-path CE1 0-alloc
CONFERMATO; controllo fe-count k=1 b=16,0) · gdc-count: ~636 chiamate,
0,031 s ⇒ fetta NON pagante DECLASSATA · verdetti `wp155-harness/s155-*.out`
