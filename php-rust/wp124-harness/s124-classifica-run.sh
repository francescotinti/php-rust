#!/bin/bash
# s124-classifica-run.sh — SOLO CONTEGGI, ricetta identica a s123-classifica-run.sh:
# R=2 su empty+6 micro ORIGINALI; gamba phpr (gacensus) + gamba oracle
# (count-interpose wp119, rieseguita fresca — l'oracle è invariato ma i raw
# si DATANO: questi sono di S-124).
set -u
