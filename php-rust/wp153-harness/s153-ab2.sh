...
{
echo "== s153-ab $TAG: A=f95a1067(gemello tree) B=$BEXP R=$R ordine ALTERNATO; giudice=objdropdef; soglia=max(4, drop-1); UB falsificabile=17.6 (4 borrow x mock 4.41); companion firmati objchurn/objdatains; guardie objalloc 13.3/objallocni 10.0/objmap 3.3 + sei SL; quiescenza rc=$QRC; rc autoritativo = ab-out/$TAG.rc =="
