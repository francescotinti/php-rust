...
## Esiti secchi
1·Istruttoria phpr1 ictx (az.rev. #4): transitorio INTERNO di primo-run (leg1
  598/s→leg2-3 ~120, istruzioni identiche, Δ-daemon≈0); RETTIFICA «3ª
  finestra»→2 su orm; rimedio rodaggio+quiescenza in campo: 4/4 gambe PULITE.
2·Coppia t10 rc=0 COMPATIBILE 1,760; parità 6/6; peak BASSE. ORM @ s159 rc=0:
  attesa-AM1 COMPATIBILE a DUE estremi (Δ_norm [+0,04;+0,24] INTERO in banda)
  · **replica-AL1 CHIUSA** (attesa sotto-risoluzione CONFERMATA).
3·fx-am v2 (az.rev. #2): 20 forme BYTE-ID (generatore, hint, func_get_args
...
5·RETTIFICA promo (incidente #21 PROPOSTO): copia con H stantio (wp159) —
  ...
  ri-derivati con esito ESATTO (fx-af BYTE-ID+marcatore; conferma D=+15,0
  5/5). Emenda proposta §3: verifica POSITIVA dei path + marcatore preteso.
