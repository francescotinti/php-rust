...
risparmiati a operazione, sei volte la soglia), ma la promozione è rinviata:
il controllo di sicurezza su un giudice esterno è così sensibile
all'«impaginazione» del binario che anche una modifica VUOTA lo farebbe
scattare — ora è misurato, e la prossima sessione corregge il controllo.
...
**Leve spedite: 0 — dichiarato; ritmo: 1 leva RIMISURATA (A/B pieno+held-out) +
1 leva-nulla.** 2026-08-08 · Fable 5 · 1a29438→d3070ba.
...
wploop 0,06 — il candidato NULLO farebbe 9,80>9,71: il gate p.7 non distingue
L-A dal nulla** ⇒ blocco L-A ATTRIBUITO a layout CON campione. Revert al byte
VERIFICATO (f71abd2a, cargo_rc=0 dal comando); patch versionata s115-zavorra2.
3·Pre-flight: disco Data ✗ (3,5G vs ~15G attesi: bundle VM Claude Desktop
7,5G del 7/8 sera — decisione utente); mitigato: A/B su binari CONSERVATI
(zero rebuild per L-A). Incidenti processo: 1 (BUILD_RC letto dopo pipe,
dichiarato e MAI usato come gate). Candidati conservati: s114-la 052ea417 ·
s114-nulla 846d0df4 · s115-nulla2 d9093a6b.
