...
APPARATO (vincoli vivi): copi-mai-mv dei tracciati · smoke col lettore
proprio · gate contesa in ogni cross/pair (fatto in aboff/mappa2) · verdetti
senza header abortiti · MAI `git add` di verdetti con run in volo (S-126).
