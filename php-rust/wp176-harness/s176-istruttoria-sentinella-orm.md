...
- ORA_REF = 4,96 = mediana delle 18 gambe pulite S-162…S-175 (4,88…5,03); REF band di phpr ri-normalizzata di conseguenza nel copione (net_norm = net × ORA_REF / oracle_net_gamba, come oggi).
- Banda sentinella = [4,86; 5,06] = ORA_REF ± 2 % (copre lo spread storico 4,88–5,03, esclude l'outlier S-161 5,31/5,42 e una gamba fredda <4,86 come s166-orm2 4,82). Ampiezza 0,20 = 4 %, pari allo spread osservato: una gamba fuori torna a significare «macchina anomala», non «giorno normale».
