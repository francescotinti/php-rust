#!/bin/bash
# s129-ab.sh <BPATH> <BEXP8> <TAG> <R> — A/B L-OL1-F4 (criterio in
# s129-criterio-f4.md, PRIMA del codice della forma): A = pin
# s127b (stash), B = leva prelude-gate. Giudice objdatains R=<R> coppie
...
{
echo "== s129-ab $TAG: A=ccb63dca(pin s127b) B=$BEXP R=$R ordine ALTERNATO; giudice=objdatains; guardie solo-regressione; rc autoritativo = ab-out/$TAG.rc =="
