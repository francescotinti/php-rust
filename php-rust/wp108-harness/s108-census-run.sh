#!/bin/bash
# s108-census-run.sh — S-108 punto 3a: census op/bigrammi SECONDO GIRO sul pin
# nuovo (la classifica dei bigrammi residui DOPO il lotto S-107 e' un'altra
...
echo "== s108 census build (feature op-census, target separato) =="
