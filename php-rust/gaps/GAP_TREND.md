...
| WP-65 | 53,77/20,89 = **2,57×** coppia singola (riferimento resta **2,58×**, G3) | 1.150,6/382,2 = **3,01×** — TERZA coppia in banda: {2,98, 3,01, 3,01}, mediana **3,01×** ⇒ KG63-A ha le sue ≥3 coppie phpr (consolidamento banda ~3,0× rimesso al concilio) | LEVA slot_names v2-style: TRE coppie full stessa-sera, fail-set **88 BYTE-ID ×2 in tutte** (run52/53/54 = run33); CPU: vs stash wp64 +2,16%/+1,23% ma **coppia build-ADIACENTE (hyg65 vs leva) −0,21% ⇒ costo leva ZERO**, il resto = spread build-vs-stash (classe run51 −1,5%; riferimento full CPU resta **2,06-2,11×**); **peak coppia adiacente −51,8MB ≈ counted ×1,00 ⇒ peak full ~1,98-2,03GB**; compile-side counted **499,9→448,3MB (−51,63MB, cumulato −77,3% da WP-62)**, slotnames_tot **51,6MB→0** (KS65-3 esatto); gate65 matrice INTEGRALE verde (cargo 1646/0 · corpus 1421 · refl 290 · ORM 3E/13F · hk 0E/0F · reverse 2F · KE-e · P1 hit_cross=2 · S-65.3); baseline **phpr-wp65 (778f8ead…)** | **1,4×** rif. |
