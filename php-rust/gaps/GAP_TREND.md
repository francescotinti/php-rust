...
| WP-63 | 54,14/21,01 = **2,58×** coppia singola = riferimento CONFERMATO (G3: il trend CPU resta 2,58×) | 1,170/0,393 = **2,98×** coppia singola — variazione STRUTTURALE (peak media 1.611-1.663 → **1.170MB, −30%** dalla STUB-ELISION default-ON); per G3 il nuovo riferimento **~3,0×** si CONFERMA con protocollo ≥3+3, il 4,1× è superato nei fatti | coppia run50 stessa-sera: new **781,32s** vs old 783,80 = **−0,32%** (CPU intatta), **peak fisico 3,896 → 2,105GB = −46,0%**, fail-set **88 BYTE-ID ×2 = run33** ✓; compile-side counted (census63-full master) 1.973,3 → **499,9MB (−74,7%)**; TRE gate pieni verdi (OFF/ON/FLIP); baseline **phpr-wp63 (1666e1b4…)**; E6: cache resta CHIUSA (dup residuo 138,4MB<150 · compile-CPU 1,97%<2 — borderline a verbale); KS63-4 scattato ⇒ tranche 2 nominata | **1,4×** rif. |
