# REPORT_GAP_44 — gap perf oracle↔phpr, cumulativo fino a WP-44
...
| WP-44 | 55,21/20,785 = **2,66×** (= old e3c8e0b su giornata pulitissima, oracle 20,75-20,80 su 4 serie; **stadio 2 registri BOCCIATO e REVERTATO**: new +1,17% v1 / +1,28% v2 consistenti su 12 round → main resta il binario WP-43) | 4,78/0,476GB = **10,0×** raw maxrss (old di giornata; MADV-rumoroso, riferimento strutturale resta ~12×) | full-suite NON rilanciata (tree revertato BYTE-IDENTICO a e3c8e0b già gated; run32 resta baseline) → riferimento resta **2,06×** | invariato **1,4×** |
