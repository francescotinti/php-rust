#!/bin/bash
# s109-ab.sh <categoria> <R> — A/B interleaved ABAB fra pin S-108 (A, stash)
# e candidato leva S-109 (B, binario CONSERVATO phpr-s109-ab-candidate:
...
B="/Volumes/Extreme Pro/Claude/phpr-old-target/release/phpr-s109-ab-candidate"
C="${1:?categoria}"; R="${2:-5}"
