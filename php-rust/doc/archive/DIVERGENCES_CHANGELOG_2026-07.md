# Archivio — changelog storico di PHPR_DIVERGENCES_FROM_PHP.md (2026-07-09 → 2026-07-27)

> Congelato il 2026-08-03. Copre le sessioni WordPress 1..27, la cui
> unica traccia narrativa è questa (i file `sessions/WP_SESSION_*.md`
> partono da WP-28). NON si aggiorna più: il catalogo vivo delle
> divergenze è `PHPR_DIVERGENCES_FROM_PHP.md`, che per regola contiene
> SOLO voci ancora aperte.
