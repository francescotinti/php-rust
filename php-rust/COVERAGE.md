...
| zlib | 29 / 30 | 97% | byte-identical via system zlib (libz-sys FFI, PHP exact deflate params); gz streams, compress.zlib:// across the file builtins, incremental DeflateContext/InflateContext; only ob_gzhandler + stream filters left |
