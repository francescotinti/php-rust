...
| tokenizer | 2 / 6 | — | `token_get_all`/`token_name`/`PhpToken` + 152 `T_*` (mago lexer); byte-identical on normal code + interpolation/heredoc + error tokens (38/49 official); TOKEN_PARSE-throw deferred |
