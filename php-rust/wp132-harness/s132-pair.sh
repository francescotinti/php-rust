#!/bin/bash
# s132-pair.sh <tentativo> — S-132 p.1: rimisura full/media WP sul pin s131,
# criterio s132-criterio-pair.md (committato PRIMA di questo codice, commit
# distinti). COPIA DICHIARATA di wp131-harness/s131-pair.sh coi SOLI
# adattamenti del criterio: pin s131; az.rev. S-131 #5 (verdetto = FILE NUOVO
...
PIN_ATTESO="ff66cb846e6cd439"
SRV_ATTESO="97ed6e0635b3f71a"
...
print(f"== s132 coppia WP full+media sul pin s131 tentativo={T} (criterio s132-criterio-pair.md) ==")
print(f"grade=VERDICT  # derivazione meccanica dai .time; rc autoritativo = pair-out/pair132-{T}.done")
