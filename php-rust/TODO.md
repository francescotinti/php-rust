...
Current state (2026-09-16, pin of session S-175, fresh corpus run): Zend corpus
...
micro-category):** micro at the S-175 pin **arith 2.4 · prop 2.6 · calls 4.6
· str 4.1 · arr 3.0 · re 2.5** (S-110: 9.3 / 7.9 / 5.1 / 5.3 / 3.9 / 3.5);
full WordPress suite **~1.77×** (pair t20, band [1.738; 1.799]); Doctrine ORM
