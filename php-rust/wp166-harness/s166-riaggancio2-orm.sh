...
# az.rev. S-163 #5) e sorveglia ANCHE mdworker; poi exec s166-lancio-orm2.sh
# (riverifica pair166-t16.done rc=0; i gate di quiescenza PER GAMBA restano
...
echo "$(date '+%F %T') quiete continua — rilancio s166-lancio-orm2.sh" >> "$LOG"
exec /bin/bash "$H/s166-lancio-orm2.sh"
